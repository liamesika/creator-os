...
import { Mail, Send, CheckCircle, Phone, MessageCircle } from 'lucide-react'
...
סוג פעילות: ${formData.companyType}
...
${formData.message}
    ...
    setTimeout(() => {
      setFormData({ name: '', email: '', phone: '', companyType: 'creator', message: '' })
      setSubmitted(false)
    }, 5000)
  }
